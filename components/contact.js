...
const Contact = () => {
  ...
  return (
    <div id="contact" className="flex min-h-screen items-center justify-start bg-gradient-to-b from-slate-300 via-slate-50 to-slate-200">
      <div className="mx-auto w-full max-w-lg">
        ...
        <form action="https://api.web3forms.com/submit" method="POST" className="mt-10">
          ...
          <button type="submit" className="mt-5 rounded-md btn_base sm:w-full md:w-1/2 lg:w-1/4 primary_btn mb-10  text-white">Envoyez</button>
        </form>
      </div>
    </div>
  );
