...
const InputDateTime = ({ label, nameDate, nameTime, valueDate, valueTime, onChange, className, errors }:any) => {
  return (
    <div className="w-1/2">
      ...
      <div className={`main-search rounded-lg shadow-md focus:shadow-lg px-5 py-2 w-full flex items-center space-x-6 border border-gray-200 border-opacity-75 ${className}`}>
        <input
          type="date"
          name={nameDate}
          id={nameDate}
