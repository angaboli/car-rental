...
const Processus = () => {
  return (
    <div id="processus">
      <div className="bg-primary-dark bg-gradient-to-r from-gray-800 to-zinc-700 text-light-gray py-8">
        <div className="w-11/12 md:max-w-[1366px] md:px-8 mx-auto flex flex-col items-start md:flex-row lg:flex-row xl:flex-row 2xl:flex-row my-12 md:my-24 overscroll-none  ">
          <div className="flex flex-col sticky md:top-36 lg:w-1/3 xl:w-1/3 2xl:w-1/4 mt-2 md:mt-12 px-8">
            <h2 className="text-tacha uppercase tracking-loose">Processus de réservation</h2>
            <p className="text-sm md:text-base text-gray-50 mb-4">
              Suivez ces étapes pour réserver votre voiture idéale.
            </p>
            <a href="#reservez"
              className="xs:w-1/2 sm:w-1/2 md:w-full bg-transparent hover:bg-gradient-to-r from-gold to-tacha text-tacha hover:text-white rounded transition ease-in duration-200 shadow hover:shadow-lg py-2 px-4 border border-tacha hover:border-transparent">
              Je réserve
            </a>
          </div>
            ...
            <div className="container mx-auto w-full h-full">
              <div className="relative wrap overflow-hidden py-5 md:p-10 h-full">
                ...
                <div className="border-2-2 absolute h-full border"
                  style={{ right: '50%', border: '2px solid #B38425', borderRadius: '1%' }}></div>
                <div className="border-2-2 absolute h-full border"
                  style={{ left: '50%', border: '2px solid #B38425', borderRadius: '1%' }}></div>
                ...
                <div className="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
                  <div className="order-1 w-5/12"></div>
                  <div className="order-1 w-5/12 px-1 py-4 text-right">
                    <p className="mb-3 text-base text-tacha">Étape 3</p>
